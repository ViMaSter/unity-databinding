// GENERATED AUTOMATICALLY FROM 'Assets/Samples/Unity Data Binding/1.0.0/Update any component automatically/AutomatedSubscriberPlayerInput.inputactions'
...
public class @AutomatedSubscriberPlayerInput : IInputActionCollection, IDisposable
{
    public InputActionAsset asset { get; }
    public @AutomatedSubscriberPlayerInput()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""AutomatedSubscriberPlayerInput"",
    ""maps"": [
        {
            ""name"": ""Default"",
    ...
    {
        private @AutomatedSubscriberPlayerInput m_Wrapper;
        public DefaultActions(@AutomatedSubscriberPlayerInput wrapper) { m_Wrapper = wrapper; }
