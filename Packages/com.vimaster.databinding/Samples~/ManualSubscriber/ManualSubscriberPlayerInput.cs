// GENERATED AUTOMATICALLY FROM 'Assets/Samples/Unity Data Binding/1.0.0/Subscribe and set values using C#/ManualSubscriberPlayerInput.inputactions'
...
public class @ManualSubscriberPlayerInput : IInputActionCollection, IDisposable
{
    public InputActionAsset asset { get; }
    public @ManualSubscriberPlayerInput()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""ManualSubscriberPlayerInput"",
    ""maps"": [
        {
            ""name"": ""Default"",
    ...
    {
        private @ManualSubscriberPlayerInput m_Wrapper;
        public DefaultActions(@ManualSubscriberPlayerInput wrapper) { m_Wrapper = wrapper; }
