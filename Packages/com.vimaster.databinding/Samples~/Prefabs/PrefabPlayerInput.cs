// GENERATED AUTOMATICALLY FROM 'Assets/Samples/Unity Data Binding/1.0.0/Automatically generate and update Prefab instances using arrays/PrefabPlayerInput.inputactions'
...
public class @PrefabPlayerInput : IInputActionCollection, IDisposable
{
    public InputActionAsset asset { get; }
    public @PrefabPlayerInput()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""PrefabPlayerInput"",
    ""maps"": [
        {
            ""name"": ""Default"",
    ...
    {
        private @PrefabPlayerInput m_Wrapper;
        public DefaultActions(@PrefabPlayerInput wrapper) { m_Wrapper = wrapper; }
